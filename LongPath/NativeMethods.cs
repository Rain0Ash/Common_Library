...
namespace Common_Library.LongPath
{
	internal static class NativeMethods
	{
		...
		internal static extern Boolean ReplaceFile(String replacedFileName, String replacementFileName, String backupFileName, Int32 dwReplaceFlags, IntPtr lpExclude, IntPtr lpReserved);
		...
		[DllImport("kernel32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
		[return: MarshalAs(UnmanagedType.Bool)]
		internal static extern Boolean SetFileAttributes(String lpFileName, [MarshalAs(UnmanagedType.U4)]System.IO.FileAttributes dwFileAttributes);
		...
		[DllImport("kernel32.dll", SetLastError = true, CharSet = CharSet.Unicode)]
		internal static extern Int32 FormatMessage(Int32 dwFlags, IntPtr lpSource, Int32 dwMessageId, Int32 dwLanguageId, StringBuilder lpBuffer, Int32 nSize, IntPtr vaListArguments);
