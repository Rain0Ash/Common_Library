...
namespace Common_Library.LongPath
{
	public class FileInfo : FileSystemInfo
	{
		...
		{
			return Common.IsRunningOnMono() ? SysFileInfo.Open(mode, access, share) : File.Open(FullPath, mode, access, share, 4096, FileOptions.SequentialScan);
		}

		public FileStream OpenRead()
		{
			return Common.IsRunningOnMono() ? SysFileInfo.OpenRead() : File.Open(FullPath, FileMode.Open, FileAccess.Read, FileShare.Read, 4096, FileOptions.None);
		}
