...
namespace Common_Library.Watchers.FileSystem
{
    ...
    {
        public static IWatcher Factory(WatcherType type, String path, String filter = "")
        {
            return Factory(type, path, TimeSpan.FromMinutes(1), filter);
        }
        
        public static IWatcher Factory(WatcherType type, String path, TimeSpan polling, String filter = "")
        {
            return type switch
            {
