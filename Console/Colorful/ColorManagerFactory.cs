...
namespace Common_Library.Colorful
{
    ...
    {
        public ColorManager GetManager(ColorStore colorStore, Int32 maxColorChanges, Int32 initialColorChangeCountValue,
        ...
        public ColorManager GetManager(ConcurrentDictionary<Color, ConsoleColor> colorMap,
            ConcurrentDictionary<ConsoleColor, Color> consoleColorMap, Int32 maxColorChanges, Int32 initialColorChangeCountValue,
            Boolean isInCompatibilityMode)
        {
